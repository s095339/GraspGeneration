...
CuboidLineIndexes = [
    # Front face
    [CuboidVertexType.FrontTopLeft, CuboidVertexType.FrontTopRight], # 1  0
    [CuboidVertexType.FrontTopRight, CuboidVertexType.FrontBottomRight],  # 0  3
    [CuboidVertexType.FrontBottomRight, CuboidVertexType.FrontBottomLeft], #  3  2
    [CuboidVertexType.FrontBottomLeft, CuboidVertexType.FrontTopLeft],  #  2   1
    # Back face
...
class Cuboid3d():
    ...
    def generate_vertexes(self):
        ...
        if (self.coord_system is None):
            ...
            #left hand rule as mentioned in objectron paper(my comment)
            self._vertices = [
